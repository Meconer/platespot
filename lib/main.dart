...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _showVersion() async {
    ...
    final buildVersion = appMyBuildVersion;
    final buildNumber = appMyBuildNumber;
    final versionText = "$appName Ver: $buildVersion Build: $buildNumber";
    Navigator.of(context).pop();
    scaffoldMsngr.showSnackBar(SnackBar(content: Text(versionText)));
  }
